...
public class E_Logical {
	...
	public void method1() {
		...
		//System.out.println(number+"는 1부터 100사의 값인가요? : "+ result);
	}
	...
	public void method2() {
		...
		// || 연사자를 기준으로 앞에서 이미 true가 나오면 뒤의 연산은 수행하지 않는다.
	...
	public void method3() {
		...
		System.out.print("입력한 문자 값이 대문자 인가? : ");

		ch = sc1.nextLine().charAt(0);
		
			
		if((ch >=65) && (ch<=90)) {
			boolean b = true;
			System.out.println(ch+"는"+b+"이다");
