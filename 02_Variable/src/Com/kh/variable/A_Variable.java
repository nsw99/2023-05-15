...
public class A_Variable {
	...
	public void printValue() {
		...
		// 변수를 사용하지 않으면
		System.out.println(2 * 10 *3.141592); //원의 둘레 
...
//		bNum = 128; // 에러 발생 -> 오버플로우(overflow)
		lNum = 9222222222L; // 숫자 뒤에 L 또는 l을 입력해야한다

		// 실수형 
		float fNum; // 4byte
		double dNum; // 8byte
		
		fNum = 3.14F; // 숫자 뒤에 f 또는 F를 입력해야한다 
		dNum = 3.14;
		...
		int NUMBER;
		int Number;
		// String number;//자료형이 달라도 변수명이 같으면 에러발생
		...
		// int 1age;
		 ...
		 // -첫글자는 항상 소문자
		 // - 여러 단어 올 떄는 각 단어의 첫 글자를 대문자로 지정
		int maxNumber;
