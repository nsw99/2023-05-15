...
public class B_Casting {
	...
	public void autoCasting() {
		...
		//byte , short 타입의 데이터는 연산 시 무조건 int 타입으로 변환후 처리한다.
		int result2 = b+s;
	...
	public void casting() {
		double d = 4.123456789456789;//15자리수까지만 가능
		float f = (float)d; //6자리수 까지만 가능
		...
		// char <-> int : 각 문자들 마다 고유한 숫자가 지정되어 있기 때문에 쌍방향으로 형변환 가능(유니코드)
